...
def is_inside_box(box_size: list[int, int], pos: position):
...
class Game:
    ...
    def setup_game(self, player1: position, player2: position):
        """
    ...
    def add_point_to(self, player: int, pos: position):
    ...
    def has_won(self):
        ...
        if player_count[1] != 0: return [True, -1]
